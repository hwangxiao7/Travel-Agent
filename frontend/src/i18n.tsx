...
const TRANSLATIONS: Record<Lang, Dict> = {
  en: {
    ...
    'itin.viral': '🔥 Trending on TikTok',
    'itin.viralTag': 'viral pick',
    'itin.guides': '📱 Travel guides',
    ...
    'auth.needLogin': 'Log in to save trips and leave reviews.',
    'auth.loggedInHint': 'Your trips & reviews personalize future recommendations.',
    'trip.save': '💾 Save this trip',
    'trip.saving': 'Saving…',
    'trip.saved': 'Trip saved to your account',
    'trip.saveFailed': 'Could not save trip',
    'review.toggle': 'Reviews',
    'review.count': 'reviews',
    'review.none': 'No reviews yet — be the first.',
    'review.rating': 'Rating',
    'review.placeholder': 'What did you think?',
    'review.submit': 'Post review',
    'review.saving': 'Posting…',
    'review.saved': 'Review posted',
    'review.failed': 'Could not post review',
  ...
  zh: {
    ...
    'auth.working': '处理中…',
    'auth.failed': '登录/注册失败',
    'auth.needLogin': '登录后可保存行程并发表评价。',
    'auth.loggedInHint': '你的行程与评价会用于个性化推荐。',
    'trip.save': '💾 保存行程',
    'trip.saving': '保存中…',
    'trip.saved': '行程已保存到账户',
    'trip.saveFailed': '保存失败',
    'review.toggle': '评价',
    'review.count': '条评价',
    'review.none': '还没有评价，来写第一条吧。',
    'review.rating': '评分',
    'review.placeholder': '说说你的体验…',
    'review.submit': '发布评价',
    'review.saving': '发布中…',
    'review.saved': '评价已发布',
    'review.failed': '发布失败',
