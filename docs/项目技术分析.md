...
> **面试资料（一站式）** → [AI-Agent与LLM专题.md](./AI-Agent与LLM专题.md)（→ [面试资料.md](./面试资料.md)）  
> **面试背稿** → [面试技术总结.md](./面试技术总结.md)（→ 面试资料）  
> **现状 / 功能清单 / Agent 工程经验速览** → [项目现状与AI-Agent工程实践.md](./项目现状与AI-Agent工程实践.md)  
...
> **本节概要。** 完整 Agent / LLM 内容见 **[面试资料.md](./面试资料.md)** §4–§5。
...
| 文档 | 内容 |
|---|---|
| **[面试资料.md](./面试资料.md)** | **一站式面试背稿（Agent + LLM + Q&A）** |
| [架构技术选型.md](./架构技术选型.md) | 为什么用 A 不用 B |
| [面试技术总结.md](./面试技术总结.md) | 精简背稿 |
